...
<div class="m-auto w-2/5 shadow-xl border-2 rounded-lg h-72 text-center flex mt-4">
	<img src={projectImgPath} alt={`${projectName} Logo`} class="h-full aspect-square rounded-l-lg" />
